...
# (Simple)ElementTree
#
# Modified to handle namespaces in a shortcut manner
# by Matt Dugan and adapted for the XDRA project
#
# --------------------------------------------------------------------
...
try:
    import elementpath as ElementPath
except ImportError:
...
#            print "Prefis is now ",prefix
        namespaces[namespace_uri] = prefix
#        namespaces[namespace_uri] = "ns%d"%len(namespaces)
        if prefix == "xml":
            xmlns = None
        else:
